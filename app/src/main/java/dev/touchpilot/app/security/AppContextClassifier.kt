...
object AppContextClassifier {
    ...
    val patterns: List<AppContextPattern> = listOf(
        ...
        AppContextPattern("pay", PolicyAppCategory.CHECKOUT_PAYMENT, MatchMode.WORD_BOUNDARY),
        AppContextPattern("payment", PolicyAppCategory.CHECKOUT_PAYMENT),
        AppContextPattern("paypal", PolicyAppCategory.CHECKOUT_PAYMENT),
        AppContextPattern("venmo", PolicyAppCategory.CHECKOUT_PAYMENT),
        AppContextPattern("cash app", PolicyAppCategory.CHECKOUT_PAYMENT),
        AppContextPattern("google wallet", PolicyAppCategory.CHECKOUT_PAYMENT),
        AppContextPattern("com.paypal", PolicyAppCategory.CHECKOUT_PAYMENT),
        AppContextPattern("com.venmo", PolicyAppCategory.CHECKOUT_PAYMENT),
        AppContextPattern("com.squareup.cash", PolicyAppCategory.CHECKOUT_PAYMENT),
        AppContextPattern("com.google.android.apps.walletnfcrel", PolicyAppCategory.CHECKOUT_PAYMENT),
